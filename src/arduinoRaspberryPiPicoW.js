...
const DIVECE_OPT = {
    type: 'arduino',
    fqbn: 'rp2040:rp2040:rpipicow:flash=2097152_0,freq=133,opt=Small,profile=Disabled,rtti=Disabled,stackprotect=Disabled,exceptions=Disabled,dbgport=Disabled,dbglvl=None,usbstack=picosdk,ipbtstack=ipv4only,uploadmethod=default', // eslint-disable-line max-len
...
class ArduinoRaspberryPiPicoW extends ArduinoPeripheral {
...
class OpenBlockArduinoRaspberryPiPicoWDevice {
    ...
    // LED on Pico W lives on the CYW43439 wireless chip, not GP25 (which is WL_CS).
    ...
    constructor (runtime) {
        ...
        this._peripheral = new ArduinoRaspberryPiPicoW(this.runtime, this.DEVICE_ID);
    }
        ...
        return [
            {
                ...
                name: formatMessage({
                    ...
                    default: 'Pins',
                    description: 'The name of the arduino RaspberryPiPicoW device pin category'
                }),
                color1: '#4C97FF',
                color2: '#3373CC',
                color3: '#3373CC',
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: 'Serial',
                    description: 'The name of the arduino RaspberryPiPicoW device serial category'
                }),
                color1: '#9966FF',
                color2: '#774DCB',
                color3: '#774DCB',
                blocks: [
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoRaspberryPiPicoW.serial.multiSerialBegin',
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: 'Data',
                    description: 'The name of the arduino RaspberryPiPicoW device data category'
                }),
                color1: '#CF63CF',
                color2: '#C94FC9',
                color3: '#BD42BD',
...
export default OpenBlockArduinoRaspberryPiPicoWDevice;
