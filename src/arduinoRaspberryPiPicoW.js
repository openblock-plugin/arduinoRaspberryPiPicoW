...
const DIVECE_OPT = {
    type: 'arduino',
    fqbn: 'rp2040:rp2040:rpipicow:flash=2097152_0,freq=133,opt=Small,profile=Disabled,rtti=Disabled,stackprotect=Disabled,exceptions=Disabled,dbgport=Disabled,dbglvl=None,usbstack=picosdk,ipbtstack=ipv4only,uploadmethod=default',
